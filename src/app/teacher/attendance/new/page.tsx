  ...
  return (
    <div className="space-y-6 max-w-2xl">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">New attendance session</h1>
          <p className="text-sm text-gray-500 mt-1">
            Choose a subject class and date. Enrolled students are added as present by default.
          </p>
        </div>
      </div>

      <NewSessionForm classSubjects={subjectOptions} />
    </div>
  );
}
