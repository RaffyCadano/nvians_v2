          ...
          <div className="px-6 py-5">
            <div className="flex items-center gap-3 rounded-xl border border-gray-100 bg-gray-50/80 p-3.5">
              ...
              <div className="min-w-0">
                ...
                <p className="truncate text-xs text-gray-500">{studentEmail}</p>
                {studentNumber ? (
                  <p className="truncate font-mono text-xs text-gray-500">#{studentNumber}</p>
                ) : null}
              </div>
            </div>
            ...
            <DialogDescription className="mt-4 text-sm leading-relaxed text-gray-600">
              {enrollmentCount > 0 ? (
                <>
                  <span className="font-medium text-gray-900">{studentName}</span> will be permanently
                  removed along with their account and enrollment records.
                </>
              ) : (
                <>
                  <span className="font-medium text-gray-900">{studentName}</span> will be permanently
                  removed from the student list and their login account will be deleted.
                </>
              )}
            </DialogDescription>
                ...
                <div className="flex gap-2.5">
                  ...
                  <div className="min-w-0 text-sm text-amber-900">
                    <p className="font-medium">
                      Enrolled in {enrollmentCount} class{enrollmentCount === 1 ? "" : "es"}
                    </p>
                    <p className="mt-1 text-xs leading-relaxed text-amber-800/90">
                      Class enrollments, attendance records, and grade history for this student
